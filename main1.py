...
pygame.mixer.init()
my_sound = pygame.mixer.Sound('erro.wav')
def click_pos(X,Y):
    comd="adb -s 127.0.0.1:5559 shell input tap "+str(X)+" "+str(Y)
    print(comd)
    os.system(comd)
...
def recheck_checkpoint(picture1,picture2):
    ...
    if(check!=True):
        ...
        print("tim ra check")
        click_pos(999.3, 266.4)
        time.sleep(2)
        os.system("adb -s 127.0.0.1:5559 shell screencap -p '/sdcard/temp.png'")
        os.system("adb -s 127.0.0.1:5559 pull /sdcard/temp.png D:\\temppc2.png")
        pic1="D:\\temppc2.png"
...
def baoloi():
    ...
    time.sleep(2)
    os.system("adb -s 127.0.0.1:5559 shell input swipe 520 1682 520 650  ")
    time.sleep(2)
    os.system("adb -s 127.0.0.1:5559 shell screencap -p '/sdcard/temp.png'")
    os.system("adb -s 127.0.0.1:5559 pull /sdcard/temp.png D:\\temppc2.png")
...
def recheck_checkpoint02(picture1,picture2):
    ...
    if(check!=True):
        ...
        baoloi()
def rework():
    os.system("adb -s 127.0.0.1:5559 shell input swipe 520 1682 520 840  ")
    os.system("adb -s 127.0.0.1:5559 shell screencap -p '/sdcard/temp.png'")
    os.system("adb -s 127.0.0.1:5559 pull /sdcard/temp.png D:\\temppc2.png")
    pic1="D:\\temppc2.png"
